/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12f9d1d297be808b5f5b3662318cded4)
// Runtime types generated with workerd@1.20260329.1 2025-11-17 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DockerRendercvApp" | "RendercvDo" | "TypstCompilerDo";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		RATE_LIMITER: RateLimit;
		TYPST_COMPILER_WASM_URL: "https://github.com/jchoi2x/typst.ts/raw/refs/heads/main-bun/packages/compiler/pkg/typst_ts_web_compiler_bg.wasm";
		...
		AUTH0_SCOPE: string;
		DOCKER_RENDERCV_APP: DurableObjectNamespace<import("./src/index").DockerRendercvApp>;
		TYPST_COMPILER: DurableObjectNamespace<import("./src/index").TypstCompilerDo>;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").RendercvDo>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TYPST_COMPILER_WASM_URL" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "S3_URL" | "S3_PUBLIC_URL" | "S3_BUCKET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY" | "AUTH0_CLIENT_ID" | "AUTH0_CLIENT_SECRET" | "AUTH0_DOMAIN" | "AUTH0_AUDIENCE" | "AUTH0_SCOPE">> {}
}
declare module "*.html" {
	const value: string;
