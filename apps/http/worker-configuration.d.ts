/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e58ad839ae292fe8f23bea31d2b8b666)
// Runtime types generated with workerd@1.20260317.1 2025-11-17 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "S3_URL" | "S3_PUBLIC_URL" | "S3_BUCKET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY" | "AUTH0_CLIENT_ID" | "AUTH0_CLIENT_SECRET" | "AUTH0_DOMAIN" | "AUTH0_AUDIENCE" | "AUTH0_SCOPE">> {}
}
declare module "*.html" {
	const value: string;
